...
// --- CONFIGURACIÓN ---
const INPUT_FOLDER = "./capturas_raw"; // Carpeta de origen
const OUTPUT_BASE = "./src/assets/img"; // Carpeta base de destino

// --- BASE DE DATOS DE PRODUCTOS (Copia idéntica de tu imagenes.js) ---
const productos = [
  // --- WINTEK: GRASA ---
  {
    id: 1,
  ...
  },
  {
    ...
    tipo: "Extractores",
    descripcion:
      "Servicio limpio y profesional. Sistema automático de pared para la extracción de aceite usado.",
    destacado: false,
  ...
  {
    id: 69,
    nombre: "Bomba PumpMaster 2 - 1:1 (Tambo 55 gal)",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Bombas",
    descripcion:
      "Versión para montaje directo en tambo de 205 litros. Incluye adaptador de 2 pulgadas.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/PM2-1-1-Drum.webp",
  },
  {
    id: 70,
    nombre: "Bomba PumpMaster 2 - 3:1 (Corto)",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Bombas",
    descripcion:
      "Presión media para sistemas de distribución de aceite en talleres pequeños y medianos.",
    destacado: true,
    imagen: "./src/assets/img/SAMSON/PM2-3-1-Stub.webp",
  },
  {
    id: 71,
    nombre: "Bomba PumpMaster 2 - 3:1 (Tambo 55 gal)",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Bombas",
    descripcion:
      "Bomba de radio 3:1 con tubo de succión para tambos estándar de 55 galones.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/PM2-3-1-Drum.webp",
  },
  {
    id: 72,
  ...
  {
    id: 73,
    nombre: "Bomba PumpMaster 4 - 5:1 (Servicio Pesado)",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Bombas",
    descripcion:
      "Potencia para bombear aceite a través de carretes y distancias medias/largas.",
    destacado: true,
    imagen: "./src/assets/img/SAMSON/PM4-5-1.webp",
  },
  {
    id: 74,
  ...
  {
    id: 76,
    nombre: "Bomba PumpMaster 3+3 - 60:1 (Grasa)",
    marca: "SAMSON",
    categoria: "Grasa",
    tipo: "Bombas",
    descripcion:
      "La campeona en presión. Ratio 60:1 para vencer la resistencia en líneas largas de grasa.",
    destacado: true,
    imagen: "./src/assets/img/SAMSON/PM3-Plus-60-1.webp",
  },
  {
    id: 77,
    nombre: "Bomba PumpMaster 45 - 40:1 (Minería)",
    marca: "SAMSON",
    categoria: "Grasa",
    tipo: "Bombas",
    descripcion:
      "Volumen y presión industrial. Para talleres de maquinaria pesada y minería.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/PM45-40-1.webp",
  },
  {
    id: 78,
  ...
  {
    id: 80,
    nombre: "Carrete Serie 506 - Aire/Agua 50'",
    marca: "SAMSON",
    categoria: "Aire",
    tipo: "Carretes",
    descripcion:
      'Mayor capacidad. Manguera de 3/8" x 15m. Ideal para talleres de servicio general.',
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Reel-506-Air-50.webp",
  },
  {
    id: 81,
    nombre: "Carrete Serie 506 - Aceite 30'",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Carretes",
    descripcion:
      'Manguera de 1/2" para un flujo óptimo de aceite. Soporta hasta 2000 psi.',
    destacado: true,
    imagen: "./src/assets/img/SAMSON/Reel-506-Oil-30.webp",
  },
  {
    id: 82,
    nombre: "Carrete Serie 506 - Aceite 50'",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Carretes",
    descripcion:
      "Alcance extendido de 15 metros. Construcción robusta en aluminio y composite.",
    destacado: true,
    imagen: "./src/assets/img/SAMSON/Reel-506-Oil-50.webp",
  },
  {
    id: 83,
    nombre: "Carrete Serie 506 - Grasa 30'",
    marca: "SAMSON",
    categoria: "Grasa",
    tipo: "Carretes",
    descripcion:
      'Manguera de alta presión SAE 100 R2 de 1/4". Diseño compacto.',
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Reel-506-Grease-30.webp",
  },
  {
    id: 84,
    nombre: "Carrete Serie 506 - Grasa 50'",
    marca: "SAMSON",
    categoria: "Grasa",
    tipo: "Carretes",
    descripcion:
      'Para servicio pesado. Manguera de 3/8" x 15m para mayor caudal de grasa.',
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Reel-506-Grease-50.webp",
  },
  ...
  {
    id: 88,
    nombre: "Pistola Control de Aceite (Mecánica)",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Pistolas",
    descripcion:
      "Modelo 363. Válvula robusta con punta anti-goteo y gatillo con traba.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Pistola-Mecanica.webp",
  },
  {
    id: 89,
  ...
  {
    id: 92,
    nombre: "Pistola de Grasa Alta Presión",
    marca: "SAMSON",
    categoria: "Grasa",
    tipo: "Pistolas",
    descripcion:
      "Modelo ergonómico con rótula Z incluida. Soporta hasta 8000 psi.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Pistola-Grasa.webp",
  },
  ...
  {
    id: 95,
    nombre: "Bomba Manual de Palanca (Aceite)",
    marca: "SAMSON",
    categoria: "Aceite",
    tipo: "Bombas",
    descripcion: "Bomba manual telescópica para tambos de 16 a 55 galones.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Manual-Lever-Pump.webp",
  },
  {
    id: 96,
    nombre: "Bomba Rotativa Manual",
    marca: "SAMSON",
    categoria: "Diesel",
    tipo: "Bombas",
    descripcion:
      "Cuerpo de hierro fundido. Ideal para diesel y aceites ligeros. Uso rudo.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Manual-Rotary-Pump.webp",
  },
  {
    id: 97,
    nombre: "Bomba de Sifón (Solventes)",
    marca: "SAMSON",
    categoria: "Otros",
    tipo: "Bombas",
    descripcion:
      "Acción de palanca simple. Materiales compatibles con solventes y químicos ligeros.",
    destacado: false,
    imagen: "./src/assets/img/SAMSON/Siphon-Pump.webp",
  },
  {
    id: 98,
  ...
  {
    id: 102,
    nombre: 'Bomba Diafragma Aluminio UL 1" (2836)',
    marca: "SAMSON",
...
async function procesarImagenes() {
  ...
  for (const producto of productos) {
    ...
    // --- MODIFICACIÓN: Lógica para detectar PNG o WEBP ---
    let sourceFile = path.join(INPUT_FOLDER, `${id}.png`);
    let extensionEncontrada = ".png";

    // Si no existe como .png, intentamos buscarlo como .webp
    if (!fs.existsSync(sourceFile)) {
      sourceFile = path.join(INPUT_FOLDER, `${id}.webp`);
      extensionEncontrada = ".webp";
    }

    // Si tampoco existe como .webp, entonces sí lanzamos la alerta
    if (!fs.existsSync(sourceFile)) {
      console.warn(`⚠️ Alerta: No encontré la imagen ${id}.png ni ${id}.webp`);
      continue;
    }
    // -----------------------------------------------------
    ...
    try {
      // Sharp acepta .webp de entrada sin problemas.
      // Esto lo leerá, lo renombrará y lo moverá a la carpeta correcta.
      await sharp(sourceFile).webp({ quality: 80 }).toFile(destFile);

      console.log(
        `✅ [ID: ${id}] (${extensionEncontrada}) Procesado y movido a -> ${cleanPath}`,
      );
    } catch (error) {
